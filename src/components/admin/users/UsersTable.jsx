        ...
        <Table striped bordered hover className="mb-2">
          ...
          <tr>
            ...
            <th
              ...
              style={{ cursor: 'pointer' }}
            >
              Ism {sortBy === 'firstName' && (sortOrder === 'asc' ? '↑' : '↓')}
            </th>
            <th
              onClick={() => toggleSort('lastName')}
              style={{ cursor: 'pointer' }}
            >
              Familiya {sortBy === 'lastName' && (sortOrder === 'asc' ? '↑' : '↓')}
            </th>
            <th
            ...
            <th
              ...
              style={{ cursor: 'pointer' }}
            >
              Telegram {sortBy === 'telegramUsername' && (sortOrder === 'asc' ? '↑' : '↓')}
            </th>
            <th
              onClick={() => toggleSort('accessUntil')}
              style={{ cursor: 'pointer' }}
            >
              Muddat {sortBy === 'accessUntil' && (sortOrder === 'asc' ? '↑' : '↓')}
            </th>
          ...
          {users.map((u) => (
            <tr key={u._id}>
              ...
              <td>{(u.group === 0 || typeof u.group === 'number') ? u.group : '—'}</td>
