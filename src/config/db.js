...
export default async function dbConnect() {
  const uri = validate(
    process.env.MONGO_URI ||
      ...
      'mongodb+srv://iskandarovfoto:QSzw5x86dV7I8DvJ@instavibe.tvfruc2.mongodb.net/?retryWrites=true&w=majority&appName=Instavibe'
  )
  const dbName =
    process.env.CACHE_PREFIX || process.env.MONGO_DB_NAME || 'instavibe_V4'

  // muammo topguncha default bufferCommands’dan foydalanamiz
